...
const MiddleContent = ()=> (
  <div className={'middle-main'}>
    ...
    <h3 className={'middle-text'}> LeaseGenius has an easy-to-use toolkit for landlords, agents and tenants.
      ...
      Tenants and landlords can log on any time through mobile or web and agents can simply integrate LeaseGenius
